      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _BookModel["default"].findById({
              _id: cart.bookId
            });
          ...
          case 27:
            ...
            _context.next = 31;
            return _BookModel["default"].findByIdAndUpdate(bookData._id, updatedData, {
              "new": true
            });
          ...
          case 38:
            ...
            _context.next = 42;
            return _BookModel["default"].findByIdAndUpdate(bookData._id, _updatedData, {
              "new": true
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 18:
            ...
            _context2.next = 30;
            return _cart["default"].findByIdAndUpdate(cartData.id, updatedCartData, {
              "new": true
            });
          ...
          case 34:
            ...
            _context2.next = 38;
            return _BookModel["default"].findByIdAndUpdate(idOfBookToUpdate, updatedBookData, {
              "new": true
            });
          ...
          case 41:
            ...
            _context2.next = 53;
            return _cart["default"].findByIdAndUpdate(cartData.id, _updatedCartData, {
              "new": true
            });
          ...
          case 56:
            ...
            _context2.next = 60;
            return _BookModel["default"].findByIdAndUpdate(_idOfBookToUpdate, _updatedBookData, {
              "new": true
            });
